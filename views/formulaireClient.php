...
<div class="jumbotron">  <!-- class="jumbotron" affiche un fond bleuté -->
...
<!-- RECUPERATION DES VALEURS -->										
			...
			<p><?php echo isset($formError['nom']) ? $formError['nom'] : '' ?></p>  <!-- affichage du message de validation ou d'erreur -->
				<!-- rappel//à JS :  id="inom" utilisé en JS dans la fonction validation -->
		</div>
...
<!-- naissance -->		
  	...
  	<div class="form-row">  <!-- nouvelle "form-row" car nouvelle ligne -->
<!-- adresse --> 
		<div class="col-lg-4">
...
<div class="container-fluid bg-dark">  <!-- class="container-fluid bg-dark" : marge à gauche + fond noir -->
	<br>
