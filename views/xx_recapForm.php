...
<!-- rol_id -->
        <div>
            ...
            <span class="error" id="errorId"><?php echo isset($formError['id']) ? $formError['id'] : '' ?></span>
        </div><br>
...
<!-- rol_intitule -->
        <div>
            ...
            <span class="error" id="errorIntitule"><?php echo isset($formError['intitule']) ? $formError['intitule'] : '' ?></span>
        </div><br>
